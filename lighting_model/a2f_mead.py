...
from model.extractor import MFCCExtractor
...
class A2FMeadModel(L.LightningModule):
    ...
    def unpack_batch(self, batch):
        ...
        return batch["audio"], batch["human_one_hot"], batch["vertexes"], batch["template"]
